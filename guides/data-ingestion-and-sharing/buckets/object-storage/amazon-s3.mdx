...
## Part 1: Setting Up Access to S3 Bucket
...
| ----------- | ----------------------------------------------- | ------------------------------ |
| Standard S3 | flexor-\<region\>-external-s3-\<customer_name\> | Data share - Customer → Flexor |
...
## Part 2: Folder & File Structure Requirements
...
- The folder name will determine the target Flexor table name.
- _Example:_ Place SEC filing documents in a folder named `sec_filings`. This will map to a table named `sec_filings`.
...
- _Example:_ `sec_filings/timestamp=2024-07-17T15:30:00Z/...files`
...
Please ensure that files in each batch directory are in the following format:
...
```
s3://flexor-us-east-1-external-s3-<customer_name>/
└── sec_filings/
    ├── timestamp=2024-07-17T15:30:00Z/
    │   ├── filing_10k_2024_001.html
    │   ├── filing_10q_2024_002.html
    │   └── filing_8k_2024_003.html
    ├── timestamp=2024-07-18T09:00:00Z/
    │   ├── filing_10k_2024_004.html
    │   └── filing_10q_2024_005.html
    └── timestamp=2024-07-19T14:45:00Z/
        ├── filing_8k_2024_006.html
        ├── filing_10k_2024_007.html
        └── filing_10q_2024_008.html
```